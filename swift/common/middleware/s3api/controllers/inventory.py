...
class InventoryController(UnsupportedController):
    """
    Handles (unimplemented) Inventory Configuration operations:
    ...
    bucket_resource_type = 'INVENTORY'
    param_resource = 'inventory'
