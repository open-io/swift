...
class OwnershipControlsController(UnsupportedController):
    """
    Handles (unimplemented) Object Ownership operations:
    ...
    bucket_resource_type = 'OWNERSHIPCONTROLS'
    param_resource = 'ownershipControls'
