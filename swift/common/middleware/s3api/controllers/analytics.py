...
class AnalyticsController(UnsupportedController):
    """
    Handles (unimplemented) Analytics Configuration operations:
    ...
    bucket_resource_type = 'ANALYTICS'
    param_resource = 'analytics'
