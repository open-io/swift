...
class AccelerateController(UnsupportedController):
    """
    Handles (unimplemented) Transfer Acceleration operations:
    ...
    bucket_resource_type = 'ACCELERATE'
    param_resource = 'accelerate'
