...
class RequestPaymentController(UnsupportedController):
    """
    Handles (unimplemented) Request Payment operations:
    ...
    bucket_resource_type = 'REQUESTPAYMENT'
    param_resource = 'requestPayment'
