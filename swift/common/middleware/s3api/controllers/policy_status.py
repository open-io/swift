...
class PolicyStatusController(UnsupportedController):
    """
    Handles (unimplemented) Bucket Policy Status operations:
    ...
    bucket_resource_type = 'POLICYSTATUS'
    param_resource = 'policyStatus'
