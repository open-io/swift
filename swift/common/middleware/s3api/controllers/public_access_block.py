...
class PublicAccessBlockController(UnsupportedController):
    """
    Handles (unimplemented) Public Access Block operations:
    ...
    bucket_resource_type = 'PUBLICACCESSBLOCK'
    param_resource = 'publicAccessBlock'
